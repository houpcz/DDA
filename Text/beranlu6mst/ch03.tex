...
Tabulku na začátek chceme. \ref{tab:klasifikacemetod}

\begin{table*}[t]\footnotesize
\vspace*{0mm}
\caption{{\label{tab:klasifikacemetod}}Příklad tabulky. Další popis i upřesnění
...
POSM & \checkmark & \checkmark & \checkmark & \checkmark & \checkmark & \checkmark &  \\ \hline
