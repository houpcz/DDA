...
Neplatí zde zcela přímá úměra. Obecně neplatí, že čím větší minimální počet kroků k dosažení cíle, tím je hra těžší. V případě, že bychom minimální počet kroků zcela maximalizovali, získáme bludiště, kde na začátku každý z tahů vede blíže k výhře. 
...
Z tohoto důvodu chceme, aby vyprchávaly více feromony, jež byly zasáhnuty náhodou. S vědomostí, které buňky zóny schopností pacient zasáhl pohybem po cestě p můžeme upravit množství feromonů na nich.
...
Algoritmus byl navržen k adaptivitě umělé inteligence jednoho z hráčů v dvouhráčové hře a ozkoušen na deskové hře backgammon (vrhcáby).
