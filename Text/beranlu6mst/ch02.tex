...
\State $vedeni = \sqrt{\frac{1}{|P|}\sum_{p \in P} |\mu_v - dobaVedeni(p)|^2}$
\State $kontrola = \frac{1}{k |P|}\sum_i^k{\sum_{p \in P} |\Delta h_i(p)|}$
\State $spravedlnost = \sqrt{\frac{1}{|P|}\sum_{p \in P} |\mu_s - s(p)|^2}$
\end{algorithmic}
\end{algorithm}
